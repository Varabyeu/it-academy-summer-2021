...
def likes(names):
    if len(names) == 0:
        ...
        text = str(names[0] + " and " + names[1] + " like this")
    elif len(names) == 3:
        text = str(names[0] + ", " + names[1] + " and " + names[2] + " like this")
    else:
        x = len(names) - 2
        text = str(names[0] + ", " + names[1] + " and " + str(x) + " others like this")
    return text



print(likes(["Peter", "Peter", "Peter", "Peter"]))